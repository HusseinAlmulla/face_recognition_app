...
const Register = ({ onRouteChange }) => {
  return (
    <article class="br5 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-4 center">
        ...
        <form class="measure">
          <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
            ...
            <div class="mt3">
              ...
              <input class="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="name" name="name" id="email-address" />
            </div>
            <div class="mv3">
